    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/HusseinAli6_6"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب سايرون ", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/HusseinAli6_6")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://youtu.be/ATAgbLGr7w")],
                [Button.url("كروب المساعدة ❓", "https://t.me/saRo_n0")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(event.chat_id,
                                 ...
                                 [Button.inline(
                                     "الاشهر َِ🛹 U+2066U+2069", data="rozmonth"),
                                  Button.inline(
                                     "اسماء القنوات َِ🛹", data="chanlan")]
                                 ])
    else:
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @saRo_n0", alert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #    قـسـم  الزغرفـة سايرون
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
...
async def settings(event): #    قـسـم  البـايو 2
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @saro_np", alert=True)
